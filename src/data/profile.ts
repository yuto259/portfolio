  ...
  focusAreas: [
    {
      ...
      description:
        "コード、ログ、データ、設計資料から処理の流れや影響範囲を整理し、実装や不具合の原因を明らかにします。",
    },
    {
      title: "バックエンド開発",
      description:
    ...
    },
    {
      title: "不具合調査・改善",
      description:
        "発生事象を整理し、関連コードやログを確認しながら原因を切り分け、修正から動作確認まで対応します。",
    },
    {
      title: "業務システム開発",
      description:
        "C#・SQLを用いた業務システムの更改やマイグレーションにおいて、設計、実装、テストを経験しています。",
    },
  ],
  whyBuildIndie:
    "AIを活用した開発手法を実践的に学ぶことに加え、実務では経験のないフロントエンド開発を学ぶため、個人開発に取り組んでいます。題材には、状態管理、条件分岐、設計、テストなど幅広い実装を経験できるゲームを選択しています。",
  futureGoals: [
