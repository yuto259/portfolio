...
export const profile: Profile = {
  ...
  careerSummary:
    "システムエンジニアとして約4年半、業務系システムの開発・改修・保守を中心に携わってきました。見積作成システムの更改、業務システムのC#マイグレーション、ERP基幹システムの保守・運用を経験し、調査・分析、基本設計、詳細設計、実装、単体テスト、結合テストまで幅広く担当しています。現在は、経済情報プラットフォームの保守・改修案件にて、企業情報を扱うREST APIの設計・実装、既存機能の改修、不具合の原因分析、テスト、リリース対応を担当しています。キャリア初期にはWebサイト制作・WordPress構築にも携わり、HTML、CSS、JavaScriptによるマークアップと画面実装を経験しました。",
  aiDevelopment:
