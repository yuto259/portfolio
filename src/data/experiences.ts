...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    overview:
      "既存の業務システムを対象としたC#マイグレーション案件に携わり、既存仕様や処理内容の調査・分析、設計、実装、テストを担当しました。既存機能の挙動を確認しながら、新しい環境へ移行するための開発を経験しています。",
    phases: ["調査", "分析", "設計", "実装", "単体テスト", "結合テスト"],
    technologies: ["C#", "SQL"],
    responsibilities: ["既存仕様や処理内容の調査・分析", "C#とSQLを用いた設計・実装", "単体テスト、結合テスト"],
    improvements: ["既存機能の挙動を確認しながら、移行後の動作差分が出ないように実装内容を整理"],
    results: [],
  ...
  },
  {
    ...
    overview:
      "見積作成システムの更改案件にて、基本設計から実装、テストまでの開発工程を経験しました。業務要件と既存仕様を確認しながら、C#とSQLを用いた機能開発・改修に取り組みました。",
    phases: ["基本設計", "詳細設計", "実装", "単体テスト", "結合テスト"],
    technologies: ["C#", "SQL"],
    responsibilities: ["業務要件と既存仕様の確認", "C#とSQLを用いた機能開発・改修", "単体テスト、結合テスト"],
    improvements: ["基本設計からテストまで、工程ごとの確認観点を整理しながら開発を進行"],
    results: [],
    teamRole: "開発担当として、設計・実装・テストを担当",
  },
  {
